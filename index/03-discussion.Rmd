...
It is also important to note that bilingual infants do seem to be able to discriminate between the two languages that they are exposed to from an early age (e.g., ###Bosch & Sebastián-Gallés, 2001; Byers-Heinlein et al., 2017; Molnar et al., 2013; Morini & Newman, 2019; Schott et al., 2021###). 
This implies that infants have some level of understanding about language categories and are aware that some words belong to particular language categories, although longitudinal research remains necessary to measure the robustness of such categories over early development (see also ###Byers-Heinlein, 2014###).
...
Our continuous measure of phonological similarity contrasts somewhat with research into the cognate facilitation effect, which often uses categorical descriptions of cognacy. 
Indeed, there is mixed evidence around the best characterisation of this phenomenon, with some studies having found significant differences between form-identical and merely form-similar TEs (e.g., ###Bosch & Ramon-Casas, 2014), whereas other studies have demonstrated a more graded effect that depends on the degree of similarity (e.g., ###Bosma et al., 2016). 
...
Additionally, it is important to note that some of the phonological similarity effect may be driven by measurement uncertainty, as it may be difficult for a caregiver to accurately attribute a child’s production to one language or the other in the case when the phonological forms are very similar. 
...
These findings extend those from previous studies on monolingual children which have found that items from different lexical categories are learnt at different rates (e.g., Chapter 11 of ###Frank et al., 2021###), and corroborate findings in adults suggesting that organisation and retrieval of lexical items in bilinguals may differ by lexical category (e.g., ###Faroqi-Shah et al., 2021###). 
