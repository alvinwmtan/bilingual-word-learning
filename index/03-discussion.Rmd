...
The current analyses reveal that age, frequency, and language exposure all predict word knowledge, providing support for Hypothesis 1.
...
The results also support the existence of a cognate advantage in TE learning, as found by @mitchellCognatesAreAdvantaged2022 among others.
Concretely, TE knowledge gives a greater boost when the TEs are more similar phonologically, affirming Hypothesis 4. 
