...
These questions, and others like them, belong to the domain of bilingual language acquisition, which is particularly important for a number of practical and theoretical reasons.
...
As such, in the current work, we examined the role of TEs in bilingual word learning.
