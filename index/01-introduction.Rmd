...
4. Greater phonological similarity predicts better word knowledge when the word's TE is known [based on studies suggesting that phonologically similar TEs are learnt earlier, e.g., @mitchellCognatesAreAdvantaged2022; @umbelMeasuringBilingualChildren1992].
